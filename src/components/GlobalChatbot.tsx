    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-3 py-2.5 border-b border-[var(--color-border-subtle)]">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 rounded-full bg-gradient-to-br from-[var(--color-accent)] to-[#06b6d4] flex items-center justify-center">
          ...
          <div>
            ...
            <p className="text-[7px] text-[var(--color-text-muted)] flex items-center gap-1">
              <span className="w-1 h-1 rounded-full bg-[var(--color-accent)] data-live" />
      ...
      >
        {messages.map((msg, idx) => (
          ...
          >
            {msg.role === 'ai' && (
              <div className="w-5 h-5 rounded-full bg-gradient-to-br from-[var(--color-accent)] to-[#06b6d4] flex items-center justify-center shrink-0 mt-0.5">
            ...
            <div
              className={`max-w-[85%] rounded-lg px-2.5 py-2 ${
                msg.role === 'user'
                  ? 'bg-[rgba(0,212,255,0.1)] border border-[rgba(0,212,255,0.2)] text-[var(--color-text-primary)]'
              ...
              {msg.pdfData && (
                <div className="mt-1.5 pt-1.5 border-t border-[var(--color-border-subtle)]">
                  <div className="flex items-center gap-1.5">
                    <FileText size={9} className="text-[var(--color-accent)]" />
            ...
            {msg.role === 'user' && (
              <div className="w-5 h-5 rounded-full bg-[rgba(0,212,255,0.15)] flex items-center justify-center shrink-0 mt-0.5">
                <span className="text-[7px] text-[var(--color-accent)] font-semibold">U</span>
              </div>
            )}
          </div>
        ))}
          ...
          <div className="flex gap-2 justify-start">
            ...
            <div className="bg-[rgba(255,255,255,0.03)] border border-[var(--color-border-subtle)] rounded-lg px-2.5 py-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[8px] text-[var(--color-accent)] tracking-wider">
                  ANALYZING...
                </span>
              </div>
            </div>
        ...
        {generatingPDF && (
          <div className="flex gap-2 justify-start">
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(0,212,255,0.06), rgba(6,182,212,0.04))',
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-2.5">
                ...
                <div>
                  <div className="text-[8px] text-[var(--color-accent)] tracking-[0.2em] font-semibold">
                    GENERATING PDF
                  </div>
                  ...
                  <div key={phase} className="flex items-center gap-1">
                    <div
                      style={{
                        ...
                        boxShadow: genProgress >= (i + 1) * 25 ? '0 0 4px rgba(0,212,255,0.5)' : 'none',
        ...
        {pdfReady && !generatingPDF && (
          <div className="flex gap-2 justify-start">
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(0,212,255,0.08), rgba(6,182,212,0.05))',
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                />
                <span className="text-[8px] text-[var(--color-accent)] tracking-[0.2em] font-semibold">
                  PDF READY
                </span>
              </div>
      ...
      <div className="px-3 py-2.5 border-t border-[var(--color-border-subtle)] bg-[var(--color-abyss)]">
        <div className="flex items-end gap-1.5">
          <textarea
            ...
            className="flex-1 px-2.5 py-2 bg-[rgba(255,255,255,0.03)] border border-[var(--color-border-subtle)] rounded-lg text-[9px] text-[var(--color-text-primary)] placeholder:text-[var(--color-text-muted)] resize-none focus:outline-none focus:border-[var(--color-accent)] focus:ring-1 focus:ring-[rgba(0,212,255,0.2)] transition-all"
            rows={1}
          ...
          <button
            ...
            className="w-8 h-8 rounded-lg bg-gradient-to-br from-[var(--color-accent)] to-[#06b6d4] flex items-center justify-center text-[var(--color-void)] disabled:opacity-50 disabled:cursor-not-allowed hover:brightness-110 transition-all active:scale-95 cursor-pointer shrink-0"
          >
            {loading ? (
